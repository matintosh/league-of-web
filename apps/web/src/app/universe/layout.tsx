...
import { UniverseCookieBannerClient } from "./cookie-banner-client";
...
export default function UniverseLayout({
  ...
  return (
    ...
    >
      ...
      <main>{children}</main>
      {/* Fixed-bottom cookie consent banner — client wrapper owns dismiss state */}
      <UniverseCookieBannerClient />
    </div>
  );
}
