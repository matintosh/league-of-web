...
|---|---|---|---|---|---|
| Homepage | `/` | `/merch` | ✅ | 2026-08-03 (re-verify #2) | FIXED (#660/#661, PR #662): announcement pill + CSS marquee (reduced-motion honored, clipped no-overflow); logo lockup wordmark-then-dark-fist. #659 nav-typo revert REJECTED (oscillation — nav FROZEN, see KNOWN RESIDUAL). Minor residual to investigate: announcement dismiss ✕ may not fire (pre-existing, non-#662) |
