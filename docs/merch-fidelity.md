...
| Shop All | `/shop-all/` | `/merch/shop-all` | ⚠️ #655 | 2026-08-03 | re-verify: 2-col grid + real products MATCH. 1 delta: still has dark hero + big "SHOP ALL" heading; real = white breadcrumb bar above grid (`Home/Shop All(N)` + inline REFINE) — same fix shipped for PDP #653/#654 + Sale #643 → #655. Logged residual (NOT re-filed): chip-strip-vs-REFINE user-decision |
