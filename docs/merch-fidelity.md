...
| PDP | `/product/<h>` | `/merch/product/[handle]` | ⚠️ #649 #650 #651 | 2026-08-03 | re-verify: #627/#628 UNDER-measured. 3 deltas: gallery 4:5→1:1 square + contain (#649); price 16→28px/400 ink-dark (#650); title UPPERCASE + ls -1.44px ink-dark (#651). Observed-not-filed (3-cap): breadcrumb full-width bar above grid (structural — file next rotation), wishlist heart. Out-of-scope: "PURCHASING DISABLED" (real's live commerce state) |
