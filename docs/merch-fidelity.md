...
| Collection/category | `/category/<h>` | `/merch/collection/[handle]` | ⚠️ #657 | 2026-08-03 | re-verify RESOLVED KEY Q: real /category/<h> + /collection/<h> have NO dark hero — white breadcrumb bar (same as shop-all/sale/PDP). Ours still has dark MerchCollectionHero + big heading → #657 (drop hero → breadcrumb bar). The ✅* was optimistic; hero never removed here. Logged residual (NOT re-filed): chip-strip-vs-REFINE |
