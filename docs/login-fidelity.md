...
|---|---|---|---|---|
| Assembled /login (whole screen) | `/login` (`apps/web/src/app/login/page.tsx`) | ⬜ | — | Holistic composition: background art + centered card + all sub-regions at the login window size. Prior work shipped #780-785 + #833. First diff will establish per-region deltas. |
