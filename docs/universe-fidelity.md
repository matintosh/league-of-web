...
| universe-hero-carousel | landing | ◐ | reviewed 2026-08-13 | REVIEWED: 2 deltas #986 (arrows 64px→~130px from edges) + #987 (peek slides title-only, drop overline). Else MATCH (460px, 40px gold arrows, overline/title/underline, 3-side vignette, crest). |
...
| universe-champion-card | live-champions | ◐ | reviewed 2026-08-13 | REVIEWED (vs LIVE site computed styles): 2 deltas #988 (name color → gold-3, not near-white) + #989 (card borderless; currently border-gold-5). Else MATCH (3:4 aspect, object-cover splash, bottom scrim, font-display name, gold overline). |
...
| universe-champion-bio-hero | live-champion-bio | ◐ | reviewed 2026-08-13 | REVIEWED: 1 delta #985 (champion name → Beaufort Heavy 900; currently default 400). Else MATCH (460px hero, vignettes, crest, hairline, subtitle gold-2, name 76.8px gold-1 0.12em). |
