...
export const leagueHomeScreenShowcase: ShowcaseEntry = {
  ...
  referenceNote:
    "docs/reference/client-current-home-2025-mf.png — MVP T1 Miss Fortune featured: rail left, MF splash filling center/right, eyebrow/title/body top-left, SKINS strip + GO TO STORE bottom-right.",
  variants: [
    {
