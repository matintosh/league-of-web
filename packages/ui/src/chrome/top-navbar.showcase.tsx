...
export const topNavbarShowcase: ShowcaseEntry = {
  ...
  area: "chrome",
  description:
    "The slim top navigation bar — play CTA on the left, nav items in the center, currency and controls on the right. The band is a dark art-bleed scrim (translucent hextech-black letting the home key-art show through) with a light frosted-glass backdrop blur (#508, softened to ~6px in #523) so the splash behind it reads clearly through soft frosting. The active tab (#523) sits in a FULL-HEIGHT darker cell — a subtle vertical gradient spanning the whole band height, darker at the top where the gold chevron notches over it and lifting faintly toward the bottom — while inactive tabs are text only. Current era (#384/#386): the right side carries a menu-access icon cluster + stacked currency with an RP top-up disc. Player identity lives in the social-rail ProfileChip / top-right profile chip, not in the band. (In the showcase the band sits on a flat surface, so the blur is only visible in-app over the home splash.)",
