    ...
    <span
      ...
      style={{
        backgroundImage:
          ...
          "color-mix(in srgb, var(--color-gold-4) 18%, transparent) 0%, " +
          "color-mix(in srgb, var(--color-hextech-black) 48%, transparent) 48%, " +
          "color-mix(in srgb, var(--color-hextech-black) 80%, transparent) 100%)",
      }}
    />
  );
}
