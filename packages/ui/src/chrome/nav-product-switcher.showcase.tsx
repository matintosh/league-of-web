...
export const navProductSwitcherShowcase: ShowcaseEntry = {
  ...
  area: "chrome",
  description:
    "The current-era product / mode switcher in the top nav band's left zone (right of PLAY): LEAGUE (active, near-white) · TFT (muted) · [R] LoR (gold pill). Presentational — products in, onSelect out. Screen routing stays on the TopNavbar nav-item row (issue #403 option 2, hybrid); the Runeterra R glyph is a #386-style placeholder until an asset is sourced.",
  ...
  variants: [
    {
      name: "Reference (LEAGUE active)",
      notes:
        "The reference set left→right: LEAGUE active (near-white → gold-1), TFT muted (grey-1), [R] LoR gold pill (gold-5 fill / gold-4 border / gold-2 label). Click any tab to reselect.",
