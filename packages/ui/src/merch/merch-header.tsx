    ...
    >
      ...
      >
        ...
        <button
          ...
          className="flex shrink-0 items-center transition-opacity duration-150 hover:opacity-80"
        >
          {/*
           * Real RIOT GAMES wordmark SVG — extracted from merch.riotgames.com
           * (title: "mainLogoRiotFist21", viewBox="0 0 587.93 165").
           * Rendered at 85×27px matching the real header; fill inherits white
           * via currentColor from the parent button's color token.
           */}
          <svg
            aria-hidden="true"
            width="85"
