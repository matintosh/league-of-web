  ...
  return (
    ...
    >
      ...
      <g transform="translate(8, 114) scale(1.067)">
        ...
        <path d="M71.123 3.838V9.74h1.444V7.745h1.492l.36-1.3h-1.852v-1.27h2.119V3.838h-3.563Z" />
        <path d="M67.553 3.719a3.05 3.05 0 0 0-1.7.514 3.066 3.066 0 0 0-1.305 3.15c.118.595.409 1.142.836 1.572a3.054 3.054 0 0 0 3.332.667 3.06 3.06 0 0 0 1.373-1.13 3.077 3.077 0 0 0-.378-3.872 3.053 3.053 0 0 0-2.158-.901Zm0 4.713a1.634 1.634 0 0 1-1.518-1.012 1.65 1.65 0 0 1 .352-1.794 1.636 1.636 0 0 1 2.799 1.161c0 .436-.171.853-.478 1.162a1.633 1.633 0 0 1-1.155.483Z" />
        <path d="M49.621 13.58a5.95 5.95 0 0 1-2.201-.385 4.495 4.495 0 0 1-1.642-1.095 4.89 4.89 0 0 1-1.03-1.723 6.574 6.574 0 0 1-.365-2.246V.229h2.836V7.98c0 .887.206 1.586.618 2.097.413.512 1.01.767 1.791.767.784 0 1.381-.255 1.791-.767.41-.51.617-1.21.62-2.097V.229h2.836V8.13a6.601 6.601 0 0 1-.364 2.246A4.892 4.892 0 0 1 53.48 12.1a4.509 4.509 0 0 1-1.643 1.095 5.951 5.951 0 0 1-2.216.384Z" />
        <path d="m71.326 20.988-1.766-.34c-.794-.154-1.23-.601-1.23-1.26 0-.898.916-1.435 1.804-1.435.302 0 1.805.079 2.114 1.584l2.433-1.192c-.36-1.072-1.433-2.927-4.566-2.927-2.525 0-4.58 1.863-4.58 4.15 0 1.94 1.293 3.363 3.457 3.805l1.766.358c.873.176 1.393.673 1.393 1.332 0 .852-.721 1.369-1.875 1.38-1.403.015-2.539-1.035-2.714-2.063l-2.337 1.309C65.76 27.441 67.413 29 70.257 29c1.79 0 2.896-.694 3.506-1.276A3.913 3.913 0 0 0 75 24.904c-.003-1.976-1.406-3.476-3.674-3.916Z" />
        <path d="M64.45 19.654a6.475 6.475 0 0 0-1.425-2.076 6.69 6.69 0 0 0-2.113-1.385c-.807-.336-1.96-.547-2.57-.547h-4.42v13.122h4.412a6.689 6.689 0 0 0 4.685-1.882 6.462 6.462 0 0 0 1.426-2.07 6.643 6.643 0 0 0 0-5.158l.004-.005Zm-2.648 4.11c-.19.46-.465.878-.811 1.233-.35.353-.764.634-1.22.828-.477.208-.99.314-1.51.31h-1.546v-7.812h1.547a3.75 3.75 0 0 1 1.508.31 3.753 3.753 0 0 1 2.028 2.076 4.06 4.06 0 0 1 0 3.056l.005-.001Z" />
      </g>
