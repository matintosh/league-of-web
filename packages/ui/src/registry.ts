...
import { typographyShowcase } from "./chrome/typography.showcase";
...
import { honorCheckpointOverlayShowcase } from "./collection/honor-checkpoint-overlay.showcase";
import { masteryCelebrationOverlayShowcase } from "./collection/mastery-celebration-overlay.showcase";
...
import { gameModeCardRowShowcase } from "./lobby/game-mode-card-row.showcase";
...
import { riotGamesWordmarkShowcase } from "./login/riot-games-wordmark.showcase";
...
import { merchCategoryTileShowcase } from "./merch/merch-category-tile.showcase";
import { merchCategoryTileGridShowcase } from "./merch/merch-category-tile-grid.showcase";
import { merchCollectionHeroShowcase } from "./merch/merch-collection-hero.showcase";
import { merchCollectionListShowcase } from "./merch/merch-collection-list.showcase";
...
import { merchGiftCardBandShowcase } from "./merch/merch-gift-card-band.showcase";
...
export const registry: ShowcaseEntry[] = [
  // champ-select — alphabetical: BanStatusStrip < ChampionPickTile < ChampSelectActionBar < CountdownHeader < LockInButton < SkinCarousel < SkinThumbStrip < TeamPlayerRow
  // case-insensitive: "champi..." < "champs..." (i < s)
  banStatusStripShowcase,
  ...
  emoteTileShowcase,
  emoteWheelShowcase,
  honorCheckpointOverlayShowcase,
  masteryCelebrationOverlayShowcase,
  ...
  statsTabShowcase,
  // lobby — alphabetical: GameModeCard < GameModeCardRow < LobbyHeader < LobbyPlayerCard < LobbyProgressionPanel < MatchFoundModal < PlayerBanner < QueueStatus < QueueTypeList < RolePickerPopover < RoleSelector < RoleSlotRow
  gameModeCardShowcase,
  gameModeCardRowShowcase,
  lobbyHeaderShowcase,
