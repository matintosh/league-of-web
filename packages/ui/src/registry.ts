 ...
 */
export const registry: ShowcaseEntry[] = [currencyDisplayShowcase, hextechButtonShowcase, hextechTooltipShowcase, playerHovercardShowcase, tabBarShowcase, topNavbarShowcase, windowFrameShowcase];
