 ...
 */
export const registry: ShowcaseEntry[] = [currencyDisplayShowcase, hextechButtonShowcase, hextechTooltipShowcase, playerHovercardShowcase, topNavbarShowcase, windowFrameShowcase];
